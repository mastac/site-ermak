    ...
    <div class="container">
        ...
        <div class="row" style="margin-bottom: 50px;">
            <div class="col-8">
                ...
                <p>
                    Мы предлагаем комплекс услуг по использованию данной системы. Учитывая специфику объекта, мы применяем цифровые или аналоговые камеры видеонаблюдения. Проектирование, монтаж и настройка системы производится опытными, высокопрофессиональными и сертифицированными специалистами нашей компании.
                </p>
            </div>
            <div class="col-4">
